...
//           this.$el.html("");清除body层的thead
 ...
 //       this.$el.css('margin-top', -this.$header.outerHeight());
        this.$el.css('margin-top', "0px");//强制修改body层thead样式
        ...
        if(lashen_flag==1){
        	if(count_c<=2){
            	this.$tableBody.css('height',this.$tableBody.height()+40);
            }
        }else{
        	lashen_flag=1;
        }
...
//原：                height = this.options.height - toolbarHeight - paginationHeight;
//修改滑动条高度mcx 2018。12。19
                height = this.options.height - toolbarHeight;
...
//        css('margin-top', "0").
        css('margin-top', "0px").//用于强制修改body层thead样式
    ...
    BootstrapTable.prototype.resetWidth = function (params) {
        if (this.options.showHeader && this.options.height) {
            this.fitHeader();
        }
        if (this.options.showFooter) {
